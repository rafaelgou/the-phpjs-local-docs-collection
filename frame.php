...
$template = $twig->loadTemplate('frame.html.twig');

echo $template->render(array_merge($config, array('sections' => $sections, 'docurl' => $_REQUEST['docurl'], 'doctitle' => $_REQUEST['docurl'])));
